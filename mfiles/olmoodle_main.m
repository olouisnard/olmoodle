...
%    fprintf(1, '%s ', datastruct(n).type)
    ...
    switch datastruct(n).type
     ...
     case 'tol'
      ...
      %----------------------------------------------------------
      olmoodle_DisplayInputData ( fid,  ...
				  struct( 'sentence', datastruct(n).props.text, ...
     ...
     case 'text'
      ...
      % Pure text
      %--------------------------------------------------
      olmoodle_DisplayText (fid, ...
			    struct(...
				'sentence', datastruct(n).props.text, ...
				'opts', datastruct(n).props.opts ...
				) ) ;
     ...
     case 'question'
      ...
      olmoodle_DisplayAnswerField (fid, ...
				   struct(...
				       'sentence', datastruct(n).props.text, ...
				       'latex', datastruct(n).props.latex, ...
				       'value', myouts.(matlabname).value(iset), ...
